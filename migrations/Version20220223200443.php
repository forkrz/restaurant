 ...
 */
final class Version20220223200443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orderdetails ADD orderid INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orderdetails DROP orderid, CHANGE meal_name meal_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE meal_size meal_size VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
