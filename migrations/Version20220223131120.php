 ...
 */
final class Version20220223131120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orderdetails ADD meal_name VARCHAR(255) NOT NULL, ADD meal_size VARCHAR(255) NOT NULL, ADD quantity INT NOT NULL, ADD price NUMERIC(10, 2) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orderdetails DROP meal_name, DROP meal_size, DROP quantity, DROP price');
